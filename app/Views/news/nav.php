          ...
          <div class="collapse navbar-collapse" id="collapsibleNavbar">
            <ul class="navbar-nav  ms-auto list">
                <li class="nav-item nvitems">
                  ...
                  <li class="nav-item nvitems">
                    <a  style="font-family: cursive" class="nav-link" href="">CAB LIST</a>
                  </li>
                  <li class="nav-item nvitems">
                    <a style="font-family: cursive" class="nav-link" href="<?php echo base_url('dealers/second');?>" onclick="show" id="dealer">BOOKED ENTERIES</a>
                  </li>
